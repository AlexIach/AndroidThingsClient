package com.example.androidthingsproject.drivers.bmp180.bmp_280;

/**
 * Created by aiachimov on 10/22/17.
 */
...
public class Bmx280 implements AutoCloseable {
  ...
  public
  @Oversampling
  int getTemperatureOversampling() {
